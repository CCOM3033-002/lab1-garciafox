...
int main () {
    ...
    //declarar los primeros set de variables que se van a insertar como input
    string movie;
    ...
    cout << setw(29) << left << "Movie Name: " << "\"" << movie << "\"" << endl;
    cout << setw(29) << left << "Adult Tickets Sold: " << adult_tickets << endl;
    cout << setw(29) << left << "Childrens Tickets Sold: " << child_tickets << endl;
    cout << "Gross Box Office Profit: " << setw(5) << right << "$ " << setprecision(2) << fixed << gross_profit << endl;
    cout << "Net Box Office Profit: " << setw(7) << right << "$ " << setprecision(2) << fixed << setw(7) << net_profit << endl;
